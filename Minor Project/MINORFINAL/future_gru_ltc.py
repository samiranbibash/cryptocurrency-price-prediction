...
def baklol():
    ...
    print("Train data error:",math.sqrt(mean_squared_error(y_train,train_predict)))
    
    #Test Data RMSE
    print("Test data error:",math.sqrt(mean_squared_error(y_test,test_predict)))
    
    train_predict[90:100]
 ...
 # print("\n \n \n \n \n \n \n \n \n TEST = ", ytestforplot[:20])
    ...
    temp_index = np.linspace(actualprices_plot.shape[0]-1, actualprices_plot.shape[0]+9, num = 10) 
    #Plotting new data
    
    
    plt.title("Predicted Litecoin Prices")
